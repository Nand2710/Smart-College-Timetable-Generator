...
const PrincipalDashboard = () => {
    ...
    const fetchPrincipalDashboard = async () => {
        try {
            const data = await authAPI.getPrincipalDashboard();
        ...
        <div className="container mx-auto p-4 space-y-4 min-h-screen pb-40 py-10 max-w-7xl">
            ...
            <div className="md:hidden flex justify-between items-center mb-4">
                <h1 className="text-xl font-bold flex items-center">
                    <Calendar className="mr-2" /> Principal Dashboard
                </h1>
                <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
                    ...
                    <SheetContent className="!bg-white" side="right">
                        ...
                        <div className="space-y-4 mt-4">
                            ...
                            <div>
                                <h2 className="font-semibold mb-2">All Subjects</h2>
            ...
            <div className="hidden md:flex justify-between items-center">
                ...
                <div className="text-right">
                    <p className="font-semibold">{dashboardData?.principal?.name}</p>
            ...
            {dashboardData && <>
                ...
                <div className="grid grid-cols-1 gap-4">
                    ...
                    <Card className="hidden md:block">
                        <CardHeader>
                            <CardTitle className="flex items-center">
                                <Book className="mr-2" /> All Subjects
                            </CardTitle>
                        </CardHeader>
                        <CardContent>
                            {dashboardData.subjects.map((subject, index) => (
